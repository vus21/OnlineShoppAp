package com.example.onlineshopp.Zalopay.Api;

import com.example.onlineshopp.Zalopay.Constant.AppInfo;
import com.example.onlineshopp.Zalopay.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount,String nameuser) throws Exception {
     ...
     public JSONObject createOrder(String amount,String nameuser) throws Exception {
        CreateOrderData input = new CreateOrderData(amount,nameuser);
